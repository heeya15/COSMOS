...
CREATE TABLE `banned_user` (
  `banneduser_no` int NOT NULL AUTO_INCREMENT,
  `user_id` varchar(20) NOT NULL,
  `publicstudyroom_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`banneduser_no`),
  KEY `FKsd8bnq7vesvbnfyoy87umph5w` (`publicstudyroom_id`),
  CONSTRAINT `FKsd8bnq7vesvbnfyoy87umph5w` FOREIGN KEY (`publicstudyroom_id`) REFERENCES `public_study_room` (`publicstudyroom_id`) ON DELETE CASCADE

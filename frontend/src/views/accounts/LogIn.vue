        ...
        <center>
          <b-card bg-variant="light">
            ...
            >
              ...
              >
                <b-form-input id="nested-id" placeholder="아이디"></b-form-input>
              </b-form-group>
              ...
              <b-form-group
                ...
                label-align-sm="right"
              >
                <b-form-input id="nested-password" placeholder="비밀번호"></b-form-input>
              </b-form-group>
            </b-form-group>
      ...
      <!-- <center>
        <div style="background-color: #DAC7F9; width:600px">
          <b-form class="p-3" style="width:400px" >
            ...
            <b-button class="mt-3" style="height:50px;">LOGIN</b-button>
          </b-form>
        </div>
      </center> -->
   ...
   <section id="formHolder">
      ...
      <div class="row">
         ...
         <div class="col-sm-6 brand">
            <a href="#" class="logo">CM <span>.</span></a>

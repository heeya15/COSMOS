...
public class StudyMemberController {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "스터디 멤버 추방 성공"), @ApiResponse(code = 401, message = "인증 실패"),
			@ApiResponse(code = 404, message = "사용자 없음"), @ApiResponse(code = 500, message = "해당 회원 없음") })

...
import com.nsnt.cosmos.api.request.UserLoginPostReq;
import com.nsnt.cosmos.api.response.UserLoginDtoRes;
...
public class AuthController {
    ...
    @ApiResponses({
        @ApiResponse(code = 200, message = "성공", response = UserLoginDtoRes.class),
